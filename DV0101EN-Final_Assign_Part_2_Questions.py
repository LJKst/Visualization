...
#Plot 2 Calculate the average number of vehicles sold by vehicle type       
        ...
        title='Average Vehicle Sold by Vehicle Type'))
...
# Plot 4 bar chart for the effect of unemployment rate on vehicle type and sales
        ur = recession_data.groupby('Unemployment_Rate', 'Month')['Vehicle_Type'].Count() 
        R_chart4 = dcc.Graph(
            figure=px.bar(ur, x='Unemployment_Rate', y='Count',
            title='Effect Unemployment Rate on Vehicle Type and Sales')
        )
...
# Plot 2 Total Monthly Automobile sales using line chart.
        Y_chart2 = dcc.Graph(figure=px.bar(average_sales, x='Month', y='Automobile_Sales', 
        title='Total Monthly Automobile Sales'))

            # Plot bar chart for average number of vehicles sold during the given year
        avr_vdata=yearly_data.groupby('Year')['Automobile_Sales'].mean().reset_index()
        Y_chart3 = dcc.Graph(px.bar(avr_vdata,x='Year', y='Automobile_Sales',title='Average Vehicles Sold by Vehicle Type in the year {}'.format(input_year)))
